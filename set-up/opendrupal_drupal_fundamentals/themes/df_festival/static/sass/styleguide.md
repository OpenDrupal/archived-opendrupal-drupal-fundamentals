# Styleguide for the df_festival theme
...
This styleguide for the df_festival Drupal theme is generated with `KSS`, a
stylesheet parser,
[Spec available](https://github.com/kss-node/kss/blob/spec/SPEC.md).

The df_festival theme is a subtheme based on
...
file found in the `static/sass` directory of the df_festival drupal theme.*
